...
// ============================================================
// FILEPATH: frontend/src/app/auth/signin/page.tsx
// DESCRIPTION: Sign-in page with real OAuth integration
// ============================================================
...
export default function SignInPage() {
  ...
  useEffect(() => {
    ...
    if (error === "OAuthVerificationFailed") {
  ...
  const handleGoogleSignIn = async () => {
    if (loginAttempts >= maxAttempts) {
      toast.error("Account locked", {
        description: "Too many failed attempts. Please reset attempts.",
      });
      return;
    }
                  ...
                  <TooltipProvider>
                    <div className="space-y-3">
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent side="right" className="max-w-xs">
                          <p className="text-sm">
                            Sign in with your Google account. We&apos;ll never post without your permission.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent side="right" className="max-w-xs">
                          <p className="text-sm">
                            Sign in with your GitHub account for seamless integration with developer profiles.
                          </p>
                        </TooltipContent>
                      </Tooltip>
                    </div>
