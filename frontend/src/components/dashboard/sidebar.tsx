    ...
    <>
      ...
      <aside
        className={cn(
          ...
          "bg-sidebar border-r border-border",
          "flex flex-col",
          // CHANGED: Reduced width from w-64 to w-52 (208px)
          sidebarOpen ? "w-52" : isMobile ? "-translate-x-full w-52" : "w-16"
        )}
      >
        {/* Logo */}
        <div
                      ...
                      <TooltipTrigger asChild>
                        <Link
                          ...
                          className={cn(
                            ...
                            // CHANGED: Reduced padding from py-2.5 to py-2
                            "hover:bg-slate-100 dark:hover:bg-slate-800",
                            isActive &&
                              "bg-indigo-50 dark:bg-indigo-950 text-indigo-600 dark:text-indigo-400",
                            !isActive && "text-slate-600 dark:text-slate-400",
                        ...
                        >
                          <Icon
                            className={cn(
                              // CHANGED: Reduced icon from h-5 w-5 to h-4 w-4
                          ...
                          />
                          {(sidebarOpen || isMobile) && (
                            // CHANGED: Reduced font from font-medium to font-normal and added text-xs
